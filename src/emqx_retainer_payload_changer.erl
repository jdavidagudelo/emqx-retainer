...
get_values_from_topic(Topic) ->
  ...
  ReactorScriptFilePath = maps:get(Options, reactor_cache_get_subscription_variables_from_mqtt_topic_script_file_path, ""),
  UbidotsScriptFilePath = maps:get(Options, ubidots_cache_get_values_variables_script_file_path, ""),
